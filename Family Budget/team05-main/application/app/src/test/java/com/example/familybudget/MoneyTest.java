...
import com.example.familybudget.util.BasicEqualTester;
...
public class MoneyTest {
    ...
    public void equalsAndHashCode() {
        ...
        Assert.assertEquals("10 €", new Money(new BigDecimal(10), euroCurrency).toString());
    }
    ...
    public void ZeroMoney(){
        Money m = new Money();
        Assert.assertEquals(new BigDecimal(0),m.getAmount());
        Assert.assertEquals(euroCurrency, m.getCurrency());
    }
}