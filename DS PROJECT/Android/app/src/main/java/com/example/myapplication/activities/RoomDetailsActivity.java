...
public class RoomDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonAddDates).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void add_dates(){
        Intent intent = new Intent(RoomDetailsActivity.this, AddAvailabilityActivity.class);
